...
def pregunta_01():
    """
    La información requerida para este laboratio está almacenada en el
    ...
    archivos deben estar ubicados en la carpeta "output" ubicada en la raíz
    del repositorio.
    ...
    * sentiment: Sentimiento de la frase. Puede ser "positive", "negative"
    ...
    Cada archivo tendría una estructura similar a la siguiente:
